 ...
 * presentación a partir del nombre. Cuando la unidad reportada es "Unidad"
 * (o cualquier otra no listada aquí) significa que el producto no se mide
 * por volumen/peso, no que falte el dato: se devuelve null igual que si no
 * hubiera especificación.
 */
