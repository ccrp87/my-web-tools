...
import type { RespuestaHttp } from "./instaleap";
import { crearAdaptadorInstaleap } from "./instaleap";
...
export function crearAdaptadorEconomia(): Adaptador {
  return crearAdaptadorInstaleap({
    tienda: "La Economía",
    origen: ORIGEN,
    obtener: obtenerConCadenaCompleta,
    esTimeout: (error) => error instanceof Error && error.message === "timeout",
  });
}
